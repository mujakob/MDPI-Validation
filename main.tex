...
However, the generation (and variation) of a CAD model to include radical or novel design solutions is a resource intense modelling effort.
To support the exploration of more functional and topological different product concepts, a combined function and geometry modelling approach, enabling the automated generation of CAD models, has been proposed and developed. 
...
The FGE method and its software tool implementation were introduced and used by the design team in a conceptual study where conceptually different alternatives for identifying alternatives to meet the expected functionality of the GV.
The FGE was introduced and use in a series of design team workshops and through participatory observation in the design teams by the researchers. The applicability and validity of FGE as a design method was in addition evaluated using interviewing the design team participants and through questionnaires. 
...
In conclusion, the FGE method help designers to articulate and link the design rationale and functionality requirements to geometrical embodiment of alternative conceptual solutions. The FGE tool, which is still in a laboratory state, required facilitation by researchers, yet showed to be sufficiently capable of generating and representing the alternatives studied in real time.
}
...
\subsection{CAD literature to be added}
\citep{Camba2016a}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\funding{This work was funded \revision{by the Swedish National Aeronautics Research Programme (NFFP) in the } project MEPHISTO and executed in collaboration with GKN Aerospace.
